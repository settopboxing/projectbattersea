...
class dvbc_tx_WXGUI(grc_wxgui.top_block_gui):
    ...
    def __init__(self):
        ...
        try: center_freq = self._center_freq_config.getint('hackrf', 'freqency')
        except: center_freq = 666750000
        ...
        self.osmosdr_sink_1 = osmosdr.sink( args="numchan=" + str(1) + " " + 'hackrf=' + os.environ["HACKRFSERIAL"] + ',buffers=128,buflen=32768' )
        ...
        self.dvbc_symbolmapper_bb_0 = dvbc.symbolmapper_bb(dvbc.MOD_64QAM)
        self.dvbc_modulator_bc_0 = dvbc.modulator_bc(dvbc.MOD_64QAM)
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, './videolive/livetrans.ts', True)
